  ...
  return (
    <div className="pt-16 bg-siv-bg min-h-screen">
      <div className="max-w-lg mx-auto px-4 py-16">
        ...
        {/* ── Image décorative siwak ─────────────────────────────────── */}
        <div className="relative h-44 rounded-2xl overflow-hidden mb-10">
          <Image
            src="https://storage.googleapis.com/a1aa/image/YhGVg5vDqaLUDpHO6VFGqGsRh5y-KQWZE_oy8LqsBUI.jpg"
            alt="Siwak naturel SIVÀA Geneva — préparation de votre colis"
            fill
            className="object-cover opacity-50"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-siv-bg via-siv-bg/30 to-transparent" />
          <div className="absolute bottom-4 left-0 right-0 text-center">
            <span className="text-xs text-siv-text-variant tracking-widest uppercase">
              Votre colis est en cours de préparation à Genève 🌿
            </span>
          </div>
        </div>
        ...
        {/* ── Image siwak bas de page ────────────────────────────────── */}
        <div className="mt-10 relative h-32 rounded-xl overflow-hidden">
          <Image
            src="https://storage.googleapis.com/a1aa/image/XsHvQVnbIiS1PLi4GMlrT9mPNtVh4x3QyMvHoYT9vHQ.jpg"
            alt="Siwak premium SIVÀA — atelier genevois"
            fill
            className="object-cover opacity-25"
          />
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="font-serif text-siv-text-variant text-sm italic text-center px-6">
              Chaque bâton, sélectionné à la main. Chaque colis, préparé avec soin.
            </p>
          </div>
        </div>
